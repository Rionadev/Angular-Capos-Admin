...
export class PriceBooksComponent implements OnInit {
  ...
  rows: TableRow[] = [
    { id: 1, name: 'ORD001', customergroup: 'John Doe', outlet: 'ORD001', validfrom: 'Paid', validto: 'ORD001' },
    { id: 2, name: 'ORD002', customergroup: 'Jane Smith', outlet: 'ORD001', validfrom: 'Pending', validto: 'ORD001' },
    { id: 3, name: 'ORD003', customergroup: 'Alice Johnson', outlet: 'ORD001', validfrom: 'Refunded', validto: 'ORD001' },
    { id: 4, name: 'ORD004', customergroup: 'Bob Brown', outlet: 'ORD001', validfrom: 'Unpaid', validto: 'ORD001' },
    { id: 5, name: 'ORD005', customergroup: 'Charlie Davis', outlet: 'ORD001', validfrom: 'Paid', validto: 'ORD001' },
  ];
  ...
  private resetRow(): TableRow {
    return { id: 0, name: '', customergroup: '', outlet:'', validfrom: '', validto:''};
  }
